...
(function() {
  ...
  (function(exports) {
    ...
    */
    ...
    Handlebars.registerHelper('notEqual', function(value, test, options) {
      if (value !== test) {
        return options.fn(this);
      } else {
        return options.inverse(this);
    ...
    */
    ...
    Handlebars.registerHelper('default', function(value, defaultValue) {
      var newValue;
      newValue = value != null ? value : defaultValue;
      if (newValue) {
        return newValue;
      } else {
        return defaultValue;
  ...
  })((typeof exports === 'undefined' ? this['Swag'] = {} : exports));
