...
(function() {
  ...
  Swag.addHelper('toDuration', function(value, humanize) {
    var days, duration, hours, hoursSeconds, minuteSeconds, minutes, seconds, secondsInADay, secondsInAMinute, secondsInAnHour;
    if (humanize == null) {
      humanize = true;
    }
    if (!Utils.isUndefined(value)) {
      ...
      return Utils.err('{{toDuration}} takes one argument (number|string).');
    }
  });
