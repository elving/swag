...
(function() {
  ...
  Swag.addHelper('default', function(value, defaultValue) {
    if (!((Utils.isHandlebarsSpecific(value)) && (Utils.isHandlebarsSpecific(defaultValue)))) {
      value = Utils.result(value);
  ...
  Swag.addHelper('partial', function(name, template, data) {
    var path;
    ...
    if (Utils.isString(name)) {
      if (Swag.Handlebars.partials[name] == null) {
        if ((typeof define !== "undefined" && define !== null) && (Utils.isFunc(define)) && define.amd) {
      ...
      return Utils.err('{{partial}} the name argument must be a string.');
    }
  });
